...
public class BDTwitrendProducer {
	public static void main(String[] args) throws Exception {
		...
		if (args.length < 4) {
			System.out.println(
					"Usage: BDTwitrendProducer <twitter-consumer-key> <twitter-consumer-secret> <twitter-access-token> <twitter-access-token-secret> <topic-name> <twitter-search-keywords>");
			return;
		}
